/* @ts-self-types="./sheetkit_wasm.d.ts" */
...
export class WasmSession {
    ...
    exec(script, author) {
        ...
        try {
            ...
            const ret = wasm.wasmsession_exec(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
    ...
    static fromBytes(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsession_fromBytes(ptr0, len0);
        if (ret[2]) {
    ...
    sketch() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmsession_sketch(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    toBytes() {
        const ret = wasm.wasmsession_toBytes(this.__wbg_ptr);
    ...
    toCsv() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmsession_toCsv(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @param {string} target
     * @param {string} mode
     * @param {number} budget_tokens
     * @returns {string}
     */
    view(target, mode, budget_tokens) {
        let deferred4_0;
        let deferred4_1;
        try {
            ...
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsession_view(this.__wbg_ptr, ptr0, len0, ptr1, len1, budget_tokens);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_ic_tz_parts_7a8f3f490ae2f177: function(arg0, arg1, arg2) {
            const ret = ic_tz_parts(arg0, getStringFromWasm0(arg1, arg2));
            return ret;
        },
        __wbg_ic_tz_validate_b18df67ee1109d4d: function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sheetkit_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
